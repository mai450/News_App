                          ...
                          child: Row(
                            children: [
                              MyStack_Row(
                                ...
                                width:
                                    MediaQuery.of(context).size.width * 0.856,
                              ),
                              const SizedBox(
                                width: 10,
                              ),
        ...
        bottomNavigationBar: Container(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                NavigatButton(icon: 'assets/Icon1.svg', text: 'Home'),
                NavigatButton(icon: 'assets/fav.svg', text: 'Favorite'),
                NavigatButton(icon: 'assets/Icon3.svg', text: 'Profile'),
              ],
            ),
          ),
        ));
